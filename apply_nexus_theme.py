...
# 我們將你的 HTML/CSS 設計轉換為 NiceGUI 的 Python 結構
# 這樣既保留了你的視覺風格，又能讓 Python 控制數據更新 (Log, Status)
...
# 寫入檔案
TARGET_PATH = 'src/gui/nicegui/pages/war_room.py'
os.makedirs(os.path.dirname(TARGET_PATH), exist_ok=True)

with open(TARGET_PATH, 'w', encoding='utf-8') as f:
    f.write(WAR_ROOM_CODE.strip())

print(f"✅ NEXUS THEME APPLIED TO: {TARGET_PATH}")
print("👉 Run 'make gui' to see the new dashboard.")