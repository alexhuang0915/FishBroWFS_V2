...
class TestRunResearchWFSRequiresData2(unittest.TestCase):
    def setUp(self) -> None:
        self._tmp = tempfile.TemporaryDirectory(prefix="fishbro_test_wfs_requires_data2_")
    ...
    def test_requires_data2_fail_closed(self) -> None:
        ...
        params = {
            ...
            "season": "2026Q1",
            "dataset_id": "CME.MNQ",
            # data2_dataset_id intentionally omitted
        }
        ...
        self.assertIn("requires data2_dataset_id", err)
