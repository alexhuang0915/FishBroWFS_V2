"""Test S3 strategy NONE mode support."""
...
def test_s3_trigger_mode_none():
    ...
    params = {
        ...
        "entry_mode": "MARKET_NEXT_OPEN",
        "context_threshold": 2.0,
        "value_threshold": 3.0,  # value_val=2.0 < 3.0 → oversold
...
def test_s3_extreme_reversion_logic():
    ...
    params1 = {
        ...
        "entry_mode": "MARKET_NEXT_OPEN",
        "context_threshold": 2.0,
        "value_threshold": 3.0,  # value_val=2.0 < 3.0 → True
        "filter_threshold": 0.0,
        "context_feature_name": "context_feature",
        "value_feature_name": "value_feature",
        "filter_feature_name": "",
    ...
    params2["value_threshold"] = 1.0  # value_val=2.0 > 1.0 → False
